...
import { ErrorInterceptorProvider } from './domain/interceptors/error.interceptor';
...
import { MessagesResolver } from './domain/resolvers/messages-resolver';
  ...
  imports: [
    ...
    JwtModule.forRoot({
      config: {
        ...
        disallowedRoutes: ['localhost:44383/api/auth']
      }
    })
  ],
  providers: [
